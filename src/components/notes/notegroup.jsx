    ...
    return (
        <div className={styles.main}>
            <div className={styles.header}>
               ...
               <p style={{ backgroundColor: `${note.color}` }}>{firstLetter(note.text)}</p>
               <h1>{note?.text} </h1>
            </div>
            ...
            <div className={styles.text_area}>
                ...
                }} ref={text} onChange={(e) => handleText(e)} name="" id="" cols="110" rows="9" placeholder='Enter text here...'></textarea>
